...
public class EnemyShipDAO {
    ...
    public EnemyShipDAO(float ship_size, float ship_max_velocity, int ship_health, float ship_rate_of_fire, String shipRegionName, String bulletRegionName, float bullet_velocity, float bullet_size, int bullet_damage) {
